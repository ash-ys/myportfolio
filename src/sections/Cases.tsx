...
import imagecase from "@/assets/images/imagecase.png";
...
const cases = [
  ...
  //   name: "Ticketfam",
  //   image: image2,
  //   link: "https://ticketfam.com/",
  // },
  // {
  //   name: "Maatri",
  //   image: image3,
  //   link: "https://maatrinepal.com/",
  // },
  // {
  //   name: "Cake Lake Bakery",
  //   image: image4,
  //   link: "https://cakelakebakery.com/",
  // },
  // {
  //   name: "Pokhara Wedding",
  //   image: image5,
  //   link: "https://pokharaweddings.com/",
  // },
  // {
  //   name: "Sayatri",
  //   image: image6,
  //   link: "https://sayatri.com/",
  // },
];
              ...
              <div className="relative">
                ...
                <div className="mt-8 md:mt-0 flex justify-between items-center md:grid md:[grid-template-columns:1fr_300px_max-content] md:gap-8">
                  ...
                  <div className="relative">
                    ...
                    transition-all duration-500 z-[9]  lg:group-hover/project:scale-110"
                    >
                      <Image
                        src={image}
                        alt={`${name} image`}
                  ...
                  <div className="lg:group-hover/project:pr-8 transition-all duration-700">
                     <div className="size-6 overflow-hidden">
                      <div className="h-6 w-12 flex group-hover/project:-translate-x-1/2 transition-transform duration-400">
                        <svg
