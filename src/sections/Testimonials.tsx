...
const Testimonials: FC = () => {
  const testimonialIndex = 0; // Placeholder for current testimonial index, can be used for navigation
  return (
              ...
              <div key={name} className="grid md:grid-cols-5 md:gap-8 lg:gap-16 md:items-center">
                <div className="aspect-square md:col-span-2 md:aspect-[9/16]">
                  <Image
                    ...
                    style={{
                      objectPosition: `50% $ {image.imagePositionY * 100}%`,
                    }}
                  />
                </div>
                <blockquote className="md:col-span-3">
                  ...
                  <span>&ldquo;</span>
                  <span className="">{quote}</span><span>&rdquo;</span>
                 </div>
